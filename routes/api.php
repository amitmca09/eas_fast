...
Route::resource('stores', 'API\MarketAPIController');
...
Route::middleware('auth:api')->group(function () {
    ...
    Route::get('carts/usercart/{userid}', 'API\CartAPIController@usercart')->name('carts.usercart');
