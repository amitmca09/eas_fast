...
use App\Criteria\Stores\MarketsOfFieldsCriteria;
use App\Criteria\Stores\MarketsOfManagerCriteria;
...
//            $this->marketRepository->pushCriteria(new ActiveCriteria());
        ...
        return $this->sendResponse($markets->toArray(), 'Stores retrieved successfully');
    }
    ...
    public function show(Request $request, $id)
    {
        ...
        return $this->sendResponse($market->toArray(), 'Store retrieved successfully');
    }
