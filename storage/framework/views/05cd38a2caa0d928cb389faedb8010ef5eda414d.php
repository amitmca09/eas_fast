  ...
  <div class="card">
    <div class="card-header">
      <ul class="nav nav-tabs align-items-end card-header-tabs w-100">
        ...
        <li class="nav-item">
          <a class="nav-link" href="<?php echo route('drivers.index'); ?>"><i class="fa fa-list mr-2"></i><?php echo e(trans('lang.driver_table')); ?></a>
        </li>
        <?php endif; ?>
        ...
        <?php endif; ?>
        <li class="nav-item">
          <a class="nav-link active" href="<?php echo url()->current(); ?>"><i class="fa fa-pencil mr-2"></i><?php echo e(trans('lang.driver_edit')); ?></a>
        </li>
      </ul>
    </div>
    <div class="card-body">
      <?php echo Form::model($driver, ['route' => ['drivers.update', $driver->id], 'method' => 'patch']); ?>

      <div class="row">
        <?php echo $__env->make('drivers.fields', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
      </div>
      <?php echo Form::close(); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\eas_fast\resources\views/drivers/edit.blade.php ENDPATH**/ ?>