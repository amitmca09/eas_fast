...
<?php if(env('APP_DEMO',false)): ?>
                <div class="row mb-2">
                    <div class="col-12 callout callout-success">
                        ...
                        <p><small>User: admin@easfast.com | Password: justadmin</small></p>
                    </div>
                    <!-- /.col -->
                </div>
                <div class="row mb-2">
                    <div class="col-12 callout callout-warning">
                        ...
                        <p><small>User: manager@easfast.com | Password: justmanager</small></p>
                    </div>
                    <!-- /.col -->
                </div>
                <div class="row mb-2">
                    <div class="col-12 callout callout-danger">
                        <h6 class="text-bold">Store</h6>
                        <p><small>User: store@easfast.com | Password: justmanager</small></p>
                    </div>
                    <!-- /.col -->
                </div>
<?php endif; ?>
...
<?php echo $__env->make('layouts.auth.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\eas_fast\resources\views/auth/login.blade.php ENDPATH**/ ?>